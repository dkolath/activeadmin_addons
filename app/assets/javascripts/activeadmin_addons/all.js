...
(function(factory) {
  ...
  $(initializer$9);
  $(document).on("turbolinks:load custom:refresh", initializer$9);
  ...
  $(initializer$8);
  $(document).on("turbolinks:load custom:refresh", initializer$8);
  ...
  $(initializer$7);
  $(document).on("turbolinks:load custom:refresh", initializer$7);
  ...
  $(initializer$6);
  $(document).on("turbolinks:load custom:refresh", initializer$6);
  ...
  $(initializer$5);
  $(document).on("turbolinks:load custom:refresh", initializer$5);
  ...
  $(initializer$4);
  $(document).on("turbolinks:load custom:refresh", initializer$4);
  ...
  $(initializer$3);
  $(document).on("turbolinks:load custom:refresh", initializer$3);
  ...
  $(initializer$2);
  $(document).on("turbolinks:load custom:refresh", initializer$2);
  ...
  $(initializer$1);
  $(document).on("turbolinks:load custom:refresh", initializer$1);
